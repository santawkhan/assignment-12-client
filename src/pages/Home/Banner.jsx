    ...
    return (
        <div className="featured-item text-white  bg-fixed py-9">
            ...
            <div className="md:flex justify-center bg-slate-500 bg-opacity-40 items-center py-20    px-36">
                <Fade> <div> <img className='rounded w-2/3' src={banner} alt="" /> </div></Fade>
                <div className="md:ml-10" data-aos="fade-up"
                    data-aos-anchor-placement="bottom-center">

                    <Fade cascade damping={0.1}> <p data-aos="flip-left" className="uppercase text-orange-400 font-serif font-bold text-xl ">Online Photography Classes</p></Fade>
